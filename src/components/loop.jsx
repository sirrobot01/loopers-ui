                    ...
                    <div className="col-md-8 mx-auto mt-5">
                        <form>
                            <div className="form-group mx-auto">
                                <input type="text" placeholder="Enter a url" className="mb-3"
                                       onChange={e => this.updateInputState(e)}/>
                                <div className="col-md-4 mx-auto">
                                    <button type="button" className="btn btn-info btn-block" onClick={this.handleSubmit}
                                            disabled={this.state.loading}>Crawl !
                                    </button>
                                </div>
                            </div>
                        </form>
